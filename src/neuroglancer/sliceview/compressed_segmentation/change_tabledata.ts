...
export function updateLookupTableData(
    data: Uint32Array, newDataMap: any, offset: number, blockSize: ArrayLike<number>,
...
function getLookupRanges(
    data: Uint32Array, offset: number, numBlocks: number) {  // assume data is a Uint32Array
