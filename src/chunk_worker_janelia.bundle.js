...
//
// Janelia-specific worker bundle including clio datasource backend.
...
// Janelia-specific backends are already included via enabled_backend_modules
// Additional explicit imports can be added here if needed
