...
/**
 * @file Interactive FlyEM credentials provider.
 *
 * This module is frontend-only: it reaches the DOM (via the interactive
 * credentials UI) and must not be imported from any module that is included in
 * the chunk worker bundle.
 */
...
import type {
  DefaultTokenType,
  FlyEMToken,
} from "#src/datasource/flyem/api.js";
